...
Restart your agent (Claude Code / Cursor / Codex CLI / opencode / Hermes Agent / Gemini CLI / Antigravity IDE / Kiro / Pi) for CodeGraph to load. Pi can alternatively run `/reload`.
